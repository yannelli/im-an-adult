...
See [CONTRIBUTING.md](CONTRIBUTING.md) for the commit standard, SemVer policy, and release setup. Published versions are listed in [CHANGELOG.md](CHANGELOG.md) and on [Releases](https://github.com/yannelli/im-an-adult/releases). After the Chrome Web Store secrets are set, each SemVer GitHub Release is also submitted to the store.
